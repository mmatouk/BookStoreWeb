...
//			System.out.println(getDatabasePath(myUrl.toString()));
			...
			ResourceBundle props = ResourceBundle.getBundle("com.abc.bookstore.db");

			Class.forName("com.mysql.jdbc.Driver");
			connection = DriverManager.getConnection(props.getString("dbUrl"), props.getString("dbUser"), props.getString("dbPassword") );
